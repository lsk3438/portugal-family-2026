...
export const DAYS = [
    {
      ...
      items: [
        ...
        { t: '10h30', k: 'route', title: 'Départ vers Vilamoura', text: "Nous prenons les véhicules en direction de Vilamoura et de sa marina — environ 25 à 30 minutes de route selon la circulation." },
    ...
    },
    {
      ...
      items: [
        { t: '09h00', k: 'reveil', title: 'Réveil', text: "Lever tranquille dans la villa avant la matinée de marché." },
        { t: '09h30', k: 'repas', title: 'Petit-déjeuner à la villa', text: "Petit-déjeuner tous ensemble autour de la grande table ou sur la terrasse." },
        { t: '10h30', k: 'route', title: 'Départ pour Loulé', text: "Nous prenons les véhicules en direction de Loulé, à l’intérieur des terres, pour son marché couvert et ses ruelles — une vingtaine de minutes de route." },
        ...
        { t: '12h45', k: 'route', title: 'Départ du marché', text: "Retour aux voitures, les glacières chargées des achats du matin." },
        ...
        { t: '13h30', k: 'repas', title: 'Déjeuner à la villa', text: "Repas simple à la villa avec les produits frais du marché." },
        { t: '14h30', k: 'libre', title: 'Repos et préparation plage', text: "Sieste, piscine ou préparation des sacs de plage — crème solaire, serviettes, jeux." },
        { t: '15h30', k: 'route', title: 'Départ vers Praia da Falésia', text: "Nous reprenons les véhicules vers Albufeira et les falaises ocre de Falésia, à une vingtaine de minutes." },
        ...
        { t: '19h15', k: 'route', title: 'Retour à la villa', text: "Retour en voiture, douche et préparation du barbecue du soir." },
        ...
        { t: '22h00', k: 'soir', title: 'Piscine, musique, soirée familiale', text: "La soirée se prolonge autour de la piscine, musique et jeux pour tous." }
      ],
    ...
    },
    {
      ...
      items: [
        { t: '09h00', k: 'reveil', title: 'Réveil', text: "Lever en douceur avant la journée toboggans." },
        { t: '09h30', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner copieux à la villa : la journée sera sportive." },
        ...
        { t: '10h30', k: 'route', title: 'Départ pour Aquashow', text: "Nous prenons les véhicules vers l’Aquashow Park, à une dizaine de minutes de la villa." },
        ...
        { t: '16h00', k: 'route', title: 'Retour à la villa', text: "Retour en voiture après la fermeture des bassins." },
        { t: '17h00', k: 'libre', title: 'Douche, repos, piscine', text: "Chacun se pose : douche, sieste ou dernières longueurs dans la piscine." },
    ...
    },
    {
      ...
      items: [
        { t: '09h00', k: 'reveil', title: 'Réveil', text: "Lever matinal pour profiter de la côte ouest." },
        { t: '09h30', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner à la villa avant la route." },
        { t: '10h30', k: 'route', title: 'Départ pour Portimão', text: "Cap à l’ouest le long de la côte : nous rejoignons Portimão et la Praia da Rocha en voiture, environ 45 minutes par l’A22." },
        ...
        { t: '20h30', k: 'route', title: 'Retour au port', text: "Fin de la sortie en mer : retour au ponton et débarquement." },
    ...
    },
    {
      ...
      travel: 'Algarve → Lisbonne · environ 2 h 45 de route par l’A2',
      items: [
        { t: '07h30', k: 'reveil', title: 'Réveil', text: "Dernier réveil en Algarve — les valises sont bouclées au maximum la veille." },
        { t: '08h00', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner rapide avant de rendre la villa." },
        ...
        { t: '10h00', k: 'route', title: 'Check-out et départ vers Lisbonne', text: "État des lieux, remise des clés, puis cap au nord : environ 2 h 45 par l’A2 jusqu’à Lisbonne." },
        ...
        { t: '22h00', k: 'soir', title: 'Retour au logement', text: "Fin de la première soirée lisboète, retour à pied ou en taxi selon l’énergie de chacun." }
      ],
    ...
    },
    {
      ...
      items: [
        { t: '09h00', k: 'reveil', title: 'Réveil', text: "Réveil dans Lisbonne pour une grande journée de découverte." },
        { t: '09h30', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner au logement ou dans une pastelaria du quartier." },
        { t: '10h30', k: 'route', title: 'Départ vers le centre historique', text: "Direction la Baixa et l’Alfama, en tram, à pied ou en voiture selon le logement." },
        ...
        { t: '14h00', k: 'route', title: 'Départ vers Estoril', text: "Nous longeons le Tage puis l’océan par la route côtière jusqu’à Estoril, environ 30 minutes." },
        ...
        { t: '17h30', k: 'route', title: 'Départ vers Cascais', text: "Quelques minutes de route le long de la baie jusqu’au centre de Cascais." },
        { t: '18h00', k: 'visite', title: 'Boca do Inferno', text: "Falaises, promenade, photos, coucher de soleil à 20h35.", place: 'boca' },
        { t: '21h00', k: 'route', title: 'Retour vers Lisbonne', text: "Retour de nuit par la côte, une trentaine de minutes jusqu’à Lisbonne." },
    ...
    },
    {
      ...
      items: [
        { t: '09h00', k: 'reveil', title: 'Réveil', text: "Lever matinal : Sintra se visite tôt, avant la foule." },
        { t: '09h30', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner rapide avant la route." },
        { t: '10h30', k: 'route', title: 'Départ pour Sintra', text: "Nous prenons la route des collines de Sintra, environ 40 minutes depuis Lisbonne." },
        ...
        { t: '17h45', k: 'route', title: 'Retour vers Lisbonne', text: "Descente des collines et retour vers Lisbonne en fin d’après-midi." },
    ...
    },
    {
      ...
      items: [
        { t: '09h00', k: 'reveil', title: 'Réveil', text: "Réveil tranquille avant une journée entre parcs et monuments." },
        { t: '09h30', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner au logement." },
        { t: '10h30', k: 'route', title: 'Départ', text: "Nous partons vers le Parque Eduardo VII, en haut de l’avenue da Liberdade." },
    ...
    },
    {
      ...
      items: [
        { t: '07h30', k: 'reveil', title: 'Réveil', text: "Réveil matinal : jour de route et de mariage." },
        { t: '08h00', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner rapide au logement." },
        { t: '08h30', k: 'libre', title: 'Bagages et check-out', text: "Bagages chargés, état des lieux et remise des clés du logement lisboète." },
    ...
    },
    {
      ...
      items: [
        { t: '09h00', k: 'reveil', title: 'Réveil', text: "Premier réveil à Porto." },
        { t: '09h30', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner au logement ou dans un café du quartier." },
        { t: '10h30', k: 'route', title: 'Départ', text: "Nous descendons vers le cœur historique de Porto, la Ribeira et ses ruelles." },
    ...
    },
    {
      ...
      items: [
        { t: '08h30', k: 'reveil', title: 'Réveil', text: "Lever matinal pour la grande journée dans la vallée du Douro." },
        { t: '09h00', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner solide avant la route des vignobles." },
        { t: '10h00', k: 'route', title: 'Départ de Porto vers Pinhão', text: "Environ 1 h 35 par l’autoroute, davantage par la route panoramique." },
        { t: '12h00', k: 'visite', title: 'Arrivée dans le secteur de Pinhão', text: "Arrivée au cœur des vignobles en terrasses, au bord du fleuve.", place: 'pinhao' },
        ...
        { t: '17h45', k: 'route', title: 'Départ vers Porto', text: "Retour vers Porto par la vallée, environ 1 h 45 de route." },
        { t: '20h00', k: 'soir', title: 'Retour au logement', text: "Arrivée au logement, pause avant le dîner." },
        { t: '20h30', k: 'soir', title: 'Dîner à Porto ou au logement', text: "Dîner selon l’envie du groupe : restaurant en ville ou repas simple au logement." }
      ],
    ...
    },
    {
      ...
      items: [
        { t: '09h00', k: 'reveil', title: 'Réveil', text: "Dernier réveil du séjour, à Porto." },
        { t: '09h30', k: 'repas', title: 'Petit-déjeuner', text: "Petit-déjeuner tranquille avant les derniers achats." },
        ...
        { t: '13h00', k: 'repas', title: 'Déjeuner final à Porto', text: "Dernier repas portugais tous ensemble avant le départ." },
        { t: '14h30', k: 'libre', title: 'Dernière promenade ou récupération des bagages', text: "Dernière balade dans le quartier ou récupération des bagages au logement." },
        { t: '15h30', k: 'libre', title: 'Regroupement', text: "Toute la famille se retrouve, bagages comptés, avant de prendre la route." },
        { t: '16h00', k: 'route', title: 'Départ de Porto', text: "Fin du séjour : nous chargeons les bagages et quittons Porto vers l’aéroport ou la route du retour, le porto et les souvenirs bien calés dans les valises.", todo: 'Heure exacte à confirmer' }
      ],
